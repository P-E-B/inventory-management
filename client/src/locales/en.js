export default {
  ...
  orders: {
    ...
    submittedRestock: 'Submitted Restock Orders'
  },

  // Restocking
  restocking: {
    title: 'Restocking',
    description: 'Set a budget and review recommended restock quantities based on demand forecast',
    ...
    orderPlaced: 'Restock order submitted',
    table: {
      sku: 'SKU',
      name: 'Item',
      trend: 'Trend',
